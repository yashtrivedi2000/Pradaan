...
<html>
    ...
    <body>
        ...
        <div align="center">
            ...
            <br/>
            <input name="image" style="background-color:#FF008C;width:120px;border:none;color:white;height:30px" type="submit" value="Donate"/><br/><br/>
            <br/>
            <br/>
            <br/>
            <br/>
