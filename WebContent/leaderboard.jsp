...
<div class="header">
                    ...
                    <ul>
                        ...
                        <li class="active">
                            <a href="leaderboard.jsp">
                                <span aria-hidden="true" class="glyphicon glyphicon-signal"></span>Leaderboard</a>
                        </li>
                        <li>
                            <a href="signuprole.html">
                                <span aria-hidden="true" class="glyphicon glyphicon-user"></span>Sign-Up</a>
                        </li>
                        <li>
                            <a href="loginrole.html">
                                <span aria-hidden="true" class="glyphicon glyphicon-leaf"></span>Login</a>
                        </li>
                        <li>
        ...
        <div align="center">
        <div style="display: inline-block;margin-left:18%;font-size:24px;text-align:left;float:left">
        <%
   try{
...
%>
        ...
        <div style="display: inline-block;margin-right:15%;font-size:24px;text-align:left;float:right">
        <%
   try{
  Class.forName("com.mysql.jdbc.Driver");
  Connection connection= DriverManager.getConnection("jdbc:mysql://localhost:3306/Hackathon","root","");
