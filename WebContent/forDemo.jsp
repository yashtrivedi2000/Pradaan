...
<html>
	...
	<body>
        ...
        <div align="center">
        	<div style="display: inline-block;margin-left:8%;font-size:24px;text-align:left;">
        		<%
			    try{
        	...
        	<div style="display: inline-block;margin-left:15%;font-size:24px;text-align:left;">
        		<%
			    try{
				   Class.forName("com.mysql.jdbc.Driver");
				   Connection connection= DriverManager.getConnection("jdbc:mysql://localhost:3306/Hackathon","root","");
